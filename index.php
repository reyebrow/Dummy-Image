...
<div id="preview"> <img src=di/600x400/000/fff">
  <h2><a href="di/600x400/000/fff" target="_blank">di/600x400/000/fff</a></h2>
</div>
<form id="demo">
  <label for="size">Size
...
<h4 id="text">Raised Eyebrow Customizations</h4>
<p>&amp;text=Hello+World</p>
<ul>
  <li><strong>reland</strong> shows a dummy landscape. Useful for slideshows and photo galleries. Use the background attribute to give it a coloured border</li>
  <li><strong>video</strong> is for videos. The background/border colour thing works for this one too</li>
  <li><strong>bust</strong> shows a dummy profile picture.</li>
</ul>
...
<div id="supported-by">
<div id="bsap_1266164" class="bsarocks bsap_5031b9d18fd1a636af9ea1dd4475e83f"></div>
<a href="http://adpacks.com" id="bsap_aplink">via Ad Packs</a>
  <!--
  <p id="dreamhost"><a href="http://www.dreamhost.com/r.cgi?174422"><img src="http://www.dreamhost.com/images/rewards/125x125-a.gif" alt="Hosting Provided By Dreamhost!"></a>
    </p>
  <p id="amz-ux-design"><a href="http://www.amazon.com/gp/product/0321607376?ie=UTF8&tag=thebloofrushe-20&linkCode=as2&camp=1789&creative=390957&creativeASIN=0321607376"><img alt="A Project Guide to UX Design: For user experience designers in the field or in the making" src="img/amz-ux-design.jpg"></a><img src="http://www.assoc-amazon.com/e/ir?t=thebloofrushe-20&l=as2&o=1&a=0321607376" width="1" height="1" alt="" style="border:none !important; margin:0px !important;"></p>
  <p id="godaddy">
    <iframe src="http://affiliate.godaddy.com/ad/5032E7019E125A6C06DBF87F470956FB551C63D2FEDDEAE65245ED965FDD52D8" width="125" height="125" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" hspace="0" allowtransparency="true"></iframe>
  </p>
  <p id="amz-ia"> <a href="http://www.amazon.com/gp/product/0596527349?ie=UTF8&tag=thebloofrushe-20&linkCode=as2&camp=1789&creative=390957&creativeASIN=0596527349"><img src="img/amz-information-architecture.jpg"></a><img src="http://www.assoc-amazon.com/e/ir?t=thebloofrushe-20&l=as2&o=1&a=0596527349" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;"> </p>
  -->
</div>
